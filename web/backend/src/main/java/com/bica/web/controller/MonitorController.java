...
public class MonitorController {
    ...
    /**
     * Returns publication calendar from the publication planner.
     */
    @GetMapping("/publications")
    public ResponseEntity<List<PublicationDto>> getPublications() {
        log.debug("GET /api/monitor/publications");
        try {
            List<PublicationDto> publications = monitorService.getPublications();
