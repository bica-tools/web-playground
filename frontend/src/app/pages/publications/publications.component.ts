...
export class PublicationsComponent {
  ...
  readonly publications: Publication[] = [
    ...
    {
      title: 'Session Type State Spaces Form Lattices (Extended Abstract)',
      category: 'venue', status: 'draft',
      venue: 'ICE 2026, Urbino, Jun 12 (DisCoTec satellite)',
      deadline: 'Apr 2',
      description: '5-page extended abstract for ICE workshop. Covers core lattice result with compact proofs.',
      steps: ['1', '2'],
      pdfPath: '/papers/ice-2026.pdf',
    },
    {
      title: 'Reticulate: A Tool for Lattice Analysis of Session Type State Spaces',
      category: 'venue', status: 'draft',
      venue: 'ICE 2026 Oral Communication, Urbino, Jun 12',
      deadline: 'Apr 2',
      description: 'Oral communication presenting the Reticulate tool and live demo.',
      pdfPath: '/papers/ice-2026-oral.pdf',
      demoRoute: '/tools/analyzer',
    },
    {
      title: 'Lambda Calculus for Session-Typed Objects',
      category: 'venue', status: 'draft',
      venue: 'ICE 2026, Urbino, Jun 12 (DisCoTec satellite)',
      deadline: 'Apr 2',
      description: 'Lambda calculus with session types on objects. Progress and preservation for \u03BB_S\u2070.',
      steps: ['200b', '200d'],
      pdfPath: '/papers/ice-2026-lambda.pdf',
    },
    {
